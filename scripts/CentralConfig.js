...
$(document).ready(function() {
    ...
    if ((LANG != "cy") && (!$("body").hasClass("plainview"))) {
        var a = '<div id="cookie-law-info-bar"><span>We are hiring! Vacancy for Senior Legal Editor. <a href=\"http://senior-legal-editor.surveyanalytics.com\" id=\"CONSTANT_OPEN_URL\" class=\"cli-plugin-main-link\"  >Find out more</a>. <a href=\"#\" id=\"cookie_action_close_header\"  class=\"medium cli-plugin-button cli-plugin-main-button\" >Close</a></span></div>',
