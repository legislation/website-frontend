			...
			<body lang="{$TranslateLang}" xml:lang="{$TranslateLang}" dir="ltr" id="browse" class="intro"> 
				<div id="layout2" >
					...
					<div id="content">
						...
						<xsl:variable name="nonDraftTypes" select="$tso:legTypeMap[not(@class = ('draft','IA', 'Bill'))]" />
						...
						<div class="s_8 p_one">					
							...
							<div class="s_4 p_two legCol">
								...
								<ul class="legTypes">
									...
									<li> <a id="nisro" href="{$TranslateLangPrefix}/nisro"><xsl:value-of select="leg:TranslateText('Northern Ireland Statutory Rules and Orders')"/> 1922-1973<span></span></a> </li>
